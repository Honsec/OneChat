...
import genius.fatui.Attributes;
import genius.fatui.FlatUI;
...
public class FlatEditText extends EditText implements Attributes.AttributeChangeListener {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            TypedArray a = getContext().obtainStyledAttributes(attrs, genius.fatui.R.styleable.fl_FlatEditText);
