...
import genius.sqldb.SQLBuilder;
import genius.sqldb.annotation.Column;
import genius.sqldb.annotation.NotDBColumn;
import genius.sqldb.annotation.PrimaryKey;
import genius.sqldb.bean.EntityTable;
import genius.sqldb.bean.Property;
		...
		for(int i = 0; i < fields.length; i++) {
			...
			if(entity.getPrimaryKey() == null) {//主键设置过后即不再遍历主键注解
				...
				if(key != null) {//声明了主键字段
					...
					genius.sqldb.bean.PrimaryKey primaryKey = new genius.sqldb.bean.PrimaryKey();
